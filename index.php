        ...
        <div id="slider-revolution">
            <ul>
                <li data-transition="fade">
                    ...
                    <div class="tp-caption sft fadeout" data-x="center" data-y="265" data-speed="700" data-start="1300"
                    ...
                    <div class="tp-caption sft fadeout slider-caption-sub slider-caption-sub-3" data-x="center"
                         data-y="300" data-speed="700" data-start="1500" data-easing="easeOutBack">
                        EACH HOTEL IS
                    </div>

                    <div class="tp-caption sfb fadeout slider-caption slider-caption-3" data-x="center" data-y="340"
                    ...
                    <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center"
                         data-y="435" data-easing="easeOutBack" data-speed="700" data-start="2200">JUST LIKE YOU
                    </div>

                    <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center"
                         data-y="465" data-easing="easeOutBack" data-speed="700" data-start="2400"><img
            ...
            <div class="container">
                <div class="footer_top">
                    <div class="ot-heading row-20 mb40 text-center">
                        ...
                        <h2>Registration</h2>
                        <p class="sub">Register right now</p>
                    </div>
                    <div class="mailchimp mb30 ">
                        <div class="mailchimp-form">
                            <form action="#" method="POST">
                                <button class="awe-btn">Register</button>
                            </form>
                        </div>
                    </div>
                </div>
