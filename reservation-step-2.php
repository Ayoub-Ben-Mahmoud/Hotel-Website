<?php
      ...
      $data =  $conn->query("select * from room where disp=0 ");
                            ...
                            <div class="reservation-sidebar">
                                ...
                                <div class="reservation-sidebar_availability bg-gray">
                                    ...
                                    <div class="check_availability-field">
                                        <label>Arrive</label>
                                        <input type="text" class="awe-calendar awe-input from" disabled
                                            value="<?php echo($Arrivedate); ?>">
                                    </div>

                                    <div class="check_availability-field to">
                                        <label>Depature</label>
                                        <input type="text" class="awe-calendar awe-input" disabled
                                            placeholder="Depature" value="<?php echo($Depaturedate); ?>">
                                    </div>
                                ...
                                <div class="reservation-room">
                                    ...
                                    <?php
                                     ...
                                     echo ' <div class="reservation-room_item">
                                        <h2 class="reservation-room_name">',$d['type'],'</h2>

                                        <div class="reservation-room_img">
                                        '.(($d["type"]=='Family')?'<a href="#"><img src="images/reservation/img-1.jpg" alt=""></a>':"").'
                                        '.(($d["type"]=='Single')?'<a href="#"><img src="images/reservation/img-2.jpg" alt=""></a>':"").'
                                        '.(($d["type"]=='Luxury')?'<a href="#"><img src="images/reservation/img-3.jpg" alt=""></a>':"").'
                                        </div>
                                        ...
                                        <div class="reservation-room_text">
                                            ...
                                            <p class="reservation-room_price">
                                                <span class="reservation-room_amout">',$d['price'],'$</span> / days
                                            </p>
                                            <form method="POST"  action="reservation-step-5.php" class="awe-btn">
                                            <input name="roomid" type="hidden" value="',$d['id'],'">
                                            <input name="Arrivedate" type="hidden" value="',$Arrivedate,'">
                                            <input name="Depaturedate" type="hidden" value="',$Depaturedate,'">

                                            <button type="submit" class="awe-btn awe-btn-13 ">BOOK ROOM</button>
