<?php
      include  'connect.php';
$sql ="INSERT INTO reservation (userid,darrive,ddepart,roomid,price) VALUES (' 4,','".$_POST['Arrivedate']."', '".$_POST['Depaturedate']."', '".$_POST['roomid']."','".$_POST['price']."')";
...
<head>
    <meta charset="utf-8">
    <!-- TITLE -->
    <title>Reservation Step 4</title>
                        ...
                        <div class="col-md-offset-3 col-md-4 col-lg-6">
                            ...
                            <div class="reservation_content">
                                ...
                                <div class="reservation-chosen-message bg-gray text-center">
                                    ...
                                    <a href="index.html" class="awe-btn awe-btn-6">Index</a>
                                </div>
