...
$data =  $conn->query("select id from users where username='".$_SESSION['username']."' ");
$result = $data->fetch(PDO::FETCH_ASSOC);

$sql ="INSERT INTO reservation (userid,darrive,ddepart,roomid,price) VALUES ('".$result['id']."','".$_POST['Arrivedate']."', '".$_POST['Depaturedate']."', '".$_POST['roomid']."','".$_POST['price']."')";

$statement = $conn->prepare($sql);
$statement->execute();

$sql="UPDATE room SET disp='1' WHERE id='".$_POST['roomid']."'";
$statement = $conn->prepare($sql);
$statement->execute();
                        ...
                        <div class="col-md-offset-3 col-md-4 col-lg-6">
                            ...
                            <div class="reservation_content">
                                ...
                                <div class="reservation-chosen-message bg-gray text-center">
                                    ...
                                    <a href="index.php" class="awe-btn awe-btn-6">Index</a>
                                </div>
